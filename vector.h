...
public:
	...
	Vector2(scalar_t a = 0, scalar_t b = 0) : x(a), y(b) {} 
	...
	// scalar self-multiply 
	const Vector2 &operator*=(const scalar_t &s) 
	{
		x *= s; 
        y *= s; 
	...
	const Vector2 operator/(scalar_t s) const 
	{ 
          s = 1/s; 
	...
	// vecector equality 
     const bool operator==(const Vector2 &vec) const 
     { 
